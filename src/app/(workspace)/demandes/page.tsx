...
export default async function DemandesPage({ searchParams }: SearchProps) {
  ...
  if (!leaveRequestDelegate) {
    return (
      <main className="mx-auto w-full max-w-4xl flex-1 p-6 md:p-10">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-zinc-900">Demandes</h1>
    ...
    <main className="mx-auto w-full max-w-6xl flex-1 p-6 md:p-10">
      <div className="mb-6">
        ...
        <p className="mt-1 max-w-3xl text-sm text-zinc-600">
          Demandez des journées ou périodes d&apos;absence (CA, CF, RTT, etc.), puis suivez vos demandes.
        </p>
      </div>
                ...
                <article key={request.id} className="rounded-lg border border-zinc-200 p-3">
                  ...
                  {isPending ? (
                    <div className="mt-3 space-y-2 border-t border-zinc-200 pt-3">
                      ...
                      <form action={updateLeaveRequest} className="grid gap-2 md:grid-cols-4">
                        ...
                        <div className="md:col-span-4 flex flex-wrap items-center gap-2">
                          <button
                            type="submit"
                            className="rounded-lg border border-zinc-900 bg-zinc-900 px-2.5 py-1.5 text-xs font-medium text-white hover:bg-zinc-800"
                          >
                            Enregistrer
                          </button>
                        </div>
