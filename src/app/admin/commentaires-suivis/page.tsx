...
export default async function AdminCommentairesSuivisPage({ searchParams }: SearchProps) {
  ...
  if (!delegates.commentaryEntry || !delegates.followUpEntry) {
    return (
      <main>
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-zinc-900">Commentaires et suivis</h1>
    ...
    <main>
      ...
      <section className="mb-8 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
        <div className="mb-3 flex items-start justify-between gap-3">
          ...
          <details className="rounded-lg border border-zinc-300 bg-white">
            ...
            <form action={createCommentaryEntry} className="grid w-[900px] gap-2 border-t border-zinc-200 p-2 lg:grid-cols-8">
                    ...
                    <td className="border-b border-zinc-100 p-2">
                      <div className="flex items-center gap-2">
                        <details>
                          ...
                          <form action={updateCommentaryEntry} className="mt-2 grid min-w-[760px] gap-2 rounded-lg border border-zinc-200 bg-zinc-50 p-2 lg:grid-cols-8">
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
        <div className="mb-3 flex items-start justify-between gap-3">
          ...
          <details className="rounded-lg border border-zinc-300 bg-white">
            <summary className="cursor-pointer list-none px-2 py-1 text-sm font-semibold text-zinc-700">+</summary>
            <form action={createFollowUpEntry} className="grid w-[900px] gap-2 border-t border-zinc-200 p-2 lg:grid-cols-8">
                  ...
                  <tr key={entry.id}>
                    ...
                    <td className="border-b border-zinc-100 p-2">
                      <div className="flex items-center gap-2">
                        <details>
                          <summary className="cursor-pointer text-base leading-none" title="Modifier">✏️</summary>
                          <form action={updateFollowUpEntry} className="mt-2 grid min-w-[760px] gap-2 rounded-lg border border-zinc-200 bg-zinc-50 p-2 lg:grid-cols-8">
                            <input type="hidden" name="id" value={entry.id} />
